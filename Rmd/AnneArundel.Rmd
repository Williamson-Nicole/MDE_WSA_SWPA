...
# All Permits, 1979-2022 - with annual use total across all permits (black line) compared to system cap
## The gray line is the linear projection of water use growth over time, based on **all previous years data**
### Water use would exceed cap in 2032
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
```
# All Permits, 1996-2022 - with annual use total across all permits (black line) compared to system cap
## The gray line is the linear projection of water use growth over time, based on data from the last two permit periods **from 1996 - 2022**
### Water use would exceed cap in 2032
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
#ggsave("../Figures/AnneArundelCounty_WaterUsage_SystemCap.jpeg")
```
# All Permits, 2010-2022 - with annual use total across all permits (black line) compared to system cap
## The gray line is the linear projection of water use growth over time, based on data from the last permit periods **from 2010 - 2022**
### Water use would exceed cap in late 2028 or early 2029
```{r, echo=FALSE, message=FALSE, warning=FALSE}
