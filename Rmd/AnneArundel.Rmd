...
ggplot(data = waterusage_total_1996, aes(x = year, y= annual_avg, color = permit))+
  ...
  geom_smooth(data= waterusage_total_1996 %>% filter(permit == "total_annual_avg"), method = "lm", se = FALSE, fullrange = TRUE, linetype = "solid", aes(color = "lightgrey"))+
  stat_regline_equation(data= waterusage_total_1996 %>% filter(permit == "total_annual_avg"), label.x= 1996, label.y= 39000000, color = "black", size = 3)+ #adds regression line formual 
  stat_cor(data= waterusage_total_1996 %>% filter(permit == "total_annual_avg"), aes(label=..rr.label..), label.x=1996, label.y=37000000, color = "black", size = 3)+ #adds R2
...
#ggsave("../Figures/AnneArundelCounty_WaterUsage_SystemCap2.jpeg")
```

![](images/AnneArundelCounty_WaterUsage_SystemCap2.jpeg)
