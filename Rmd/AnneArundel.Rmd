...
# **All Permits, 2000-2022 - no annual total** 
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
ggplot(data = waterusage_total_1996, aes(x = year, y= annual_avg, color = permit))+
  ...
  #stat_cor(method = "pearson", label.x = 1988, label.y = 39000000, color = "black", size = 3)+ #adds p-value 
  #xlim(1980, 2035)+
   scale_x_continuous(limits = c(1996, 2034), breaks = seq(1996, 2034, 2))+
  theme_light()+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(), 
        axis.text.x = element_text(color = "black", size = 8, angle = 45, hjust = 1),
...
ggplot(data = waterusage_total_2010, aes(x = year, y= annual_avg, color = permit))+
  ...
  #stat_cor(method = "pearson", label.x = 1988, label.y = 39000000, color = "black", size = 3)+ #adds p-value 
  #xlim(1980, 2035)+
   scale_x_continuous(limits = c(2010, 2030), breaks = seq(2010, 2030, 1))+
  theme_light()+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(), 
        axis.text.x = element_text(color = "black", size = 8, angle = 45, hjust = 1),
